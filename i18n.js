/**
 * CV i18n — English / Español
 * EN uses industry titles; ES avoids academic "Ingeniero" claim.
 */
window.CV_I18N = {
  en: {
    ...
    btnPdf: "Download PDF",
    btnPdfAts: "ATS PDF",
    btnPdfLoading: "Generating PDF…",
    btnPdfAtsLoading: "Generating ATS…",
    pdfFilename: "Eulemis-Hernandez-CV-EN.pdf",
    pdfFilenameAts: "Eulemis-Hernandez-CV-ATS-EN.pdf",
    ...
    payments: "Payments",
    backendSkills:
      "Laravel 9/10/11 · PHP · Symfony · REST APIs · Sanctum · Reverb · SOLID · Service Layer / DTOs",
    frontendSkills:
      "React 18 · TypeScript · Vue.js · AngularJS · Tailwind · Vite · PWA · React Native / Expo",
    dbSkills:
      "MySQL · Redis · SQLite · IndexedDB / Dexie · SQL Optimization · Indexing · Lazy Loading",
    cloudSkills:
      "AWS (IVS, MediaConvert, S3, CloudFront) · DigitalOcean · Linux · Nginx / Apache · Git · CI/CD",
    paymentSkills: "Stripe · PayPal · MercadoPago",
    strengths: "Strengths",
    strength1: "SaaS & Multi-Tenant Architecture",
    strength2: "Backend Engineering (Laravel)",
    strength3: "React & Full Stack",
    strength4: "Cloud Infrastructure (AWS)",
    strength5: "Clean Architecture & SOLID",
    strength6: "SQL Optimization",
    strength7: "Offline-First / PWA",
    strength8: "Real-time (WebSockets)",
    strength9: "Mobile (React Native)",
    strength10: "Payment Gateway Integration",
  ...
  es: {
    docTitle: "Eulemis Hernández — Desarrollador Senior de Software CV",
    docDescription:
      "Currículum Vitae — Eulemis Hernández, Desarrollador Senior de Software | Arquitecto Backend | Especialista SaaS & Cloud",
    brand: "Eulemis Hernández · CV",
    btnPrint: "Imprimir",
    btnPdf: "Descargar PDF",
    btnPdfAts: "PDF ATS",
    btnPdfLoading: "Generando PDF…",
    btnPdfAtsLoading: "Generando ATS…",
    pdfFilename: "Eulemis-Hernandez-CV-ES.pdf",
    pdfFilenameAts: "Eulemis-Hernandez-CV-ATS-ES.pdf",
    email: "eulemisalfredo@gmail.com",
    phone: "+58 412 016-9750",
    linkedin: "linkedin.com/in/eulemis-hernandez",
    github: "github.com/eulemis",
    ...
    payments: "Pagos",
    backendSkills:
      "Laravel 9/10/11 · PHP · Symfony · APIs REST · Sanctum · Reverb · SOLID · Service Layer / DTOs",
    frontendSkills:
      "React 18 · TypeScript · Vue.js · AngularJS · Tailwind · Vite · PWA · React Native / Expo",
    dbSkills:
      "MySQL · Redis · SQLite · IndexedDB / Dexie · Optimización SQL · Indexación · Lazy Loading",
    cloudSkills:
      "AWS (IVS, MediaConvert, S3, CloudFront) · DigitalOcean · Linux · Nginx / Apache · Git · CI/CD",
    paymentSkills: "Stripe · PayPal · MercadoPago",
    strengths: "Fortalezas",
    strength1: "Arquitectura SaaS y Multi-Tenant",
    strength2: "Backend (Laravel)",
    strength3: "React y Full Stack",
    strength4: "Infraestructura Cloud (AWS)",
    strength5: "Clean Architecture y SOLID",
    strength6: "Optimización SQL",
    strength7: "Offline-First / PWA",
    strength8: "Tiempo real (WebSockets)",
    strength9: "Móvil (React Native)",
    strength10: "Integración de pasarelas de pago",
